...
pro user_metrics_nps, ndvi, v2, bn, metrics_cal_threshold, out_v
...
metrics=ComputeMetrics(NDVI,wl,bpy,CurrentBand,DaysPerBand)
...
if endp LE 0 or onp LE 0 or endp -onp LE 6 then begin
