FUNCTION GetCrossOver_percentage_extremeslope_ver15_org, Xref, Yref, XData, YData, bq, bpy, UP=up, DOWN=down, ALL=ALL
...
;               ( (BetweenD AND BetweenR) and (Xstar GT max([mxidxed,0.5*bpy])) and UP ) then begin
            ...
            if ( (BetweenD AND BetweenR) and (Xstar LT mxidxst ) and DOWN ) or $
               ( (BetweenD AND BetweenR) and (Xstar GT mxidxed ) and UP ) then begin
