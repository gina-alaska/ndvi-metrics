...
pro smooth_calculate_metrics_tile,filen,flg
...
threshold = 80b ; for point with value below threshold, after convert into 0-20, this value is equal to 80
...
;---calls time_series_process to do interpolate, smooth, and calculate metrics

time_series_process,tmp,bnames,threshold,snowcld,mid_interp,mid_smooth,mid_bname,vmetrics
