...
SOS=GetSOS_ver16(Starts, NDVI,bq,Time, bpy, FMA) ;dayindex of start season and related ndvi valuei, quarentee possib sos > threshold,
                                                     ; possib eos  less than threshold  
                                                     ;                                                      
...
EOS=GetEOS_ver16(Ends, NDVI, bq, Time,bpy,SOS,bma) ; find last 20% point, get the possibx which is the nearest to the last 20% point, copare th possibx and the last 20%point,
